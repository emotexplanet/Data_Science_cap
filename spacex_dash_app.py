...
def get_pie_chart(launch_site):
    if launch_site == 'ALL Sites':
        ...
        title='Total Success Launch Site {}'.format(launch_site))
        return(fig)
...
def get_payload_chart(launch_site, payload_mass):
    if launch_site == 'ALL Sites':
        ...
        title='Correlation between Payload and Success Launch for All Sites')
        return(fig)
    else:
        # return the outcomes piechart for a selected site
        ...
        color="Booster Version Category",
        hover_data=['Launch Site'],
        title='Correlation between Payload and Success Launch for Site {}'.format(launch_site))
        return(fig)
